...
# Config 
class Config(object):
    BOT_TOKEN = os.environ.get("BOT_TOKEN", "8061687939:AAGQAyS_0spxGN-cHbPG2MCB3q5lLHbV0H8")
    API_ID = int(os.environ.get("API_ID",  "18261425"))
    API_HASH = os.environ.get("API_HASH", "e1769ecf40907d83ac5bb43cb11e31dd")
